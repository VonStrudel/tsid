  ...
  {    
    ...
    : public boost::python::def_visitor< InvDynPythonVisitor<T> >
    {
      ...
      void visit(PyClass& cl) const
      {
        ...
        .def("addMotionTask", &InvDynPythonVisitor::addMotionTask_Wall, bp::args("task", "weight", "priorityLevel", "transition duration"))
      ...
      static bool addMotionTask_Wall(T & self, tasks::TaskWall & task, double weight, unsigned int priorityLevel, double transition_duration){
        return self.addMotionTask(task, weight, priorityLevel, transition_duration);
      }
