...
IF(NOT EXISTS "/opt/openrobots/src/tsid/_build-RELEASE/install_manifest.txt")
  MESSAGE(FATAL_ERROR "Cannot find install manifest:\"/opt/openrobots/src/tsid/_build-RELEASE/install_manifest.txt\"")
ENDIF(NOT EXISTS "/opt/openrobots/src/tsid/_build-RELEASE/install_manifest.txt")

MESSAGE(STATUS "catkin path: /openrobots/.catkin")
IF(EXISTS "/openrobots/.catkin")
  MESSAGE(STATUS "Try to remove /openrobots/.catkin")
  EXECUTE_PROCESS(
      COMMAND /usr/bin/cmake -E remove "/openrobots/.catkin"
      RESULT_VARIABLE rm_resval
      OUTPUT_VARIABLE rm_out
      ERROR_VARIABLE rm_err
       )
ENDIF(EXISTS "/openrobots/.catkin")


FILE(READ "/opt/openrobots/src/tsid/_build-RELEASE/install_manifest.txt" files)
